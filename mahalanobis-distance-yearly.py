...
df_main = pd.read_csv("shorter_ipc_ARS3.csv")
df_share = pd.read_csv("shorter_ipc_ARS3_share.csv")
...
all_results.to_csv("mahalanobis-distances-yearly-new.csv", index=False)
